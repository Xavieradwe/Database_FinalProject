...
class Recipients(models.Model):
    recipient_id = models.AutoField(primary_key=True)  # Unique auto-increment primary key
    message = models.ForeignKey('Messages', models.DO_NOTHING, null=True, blank=True)
